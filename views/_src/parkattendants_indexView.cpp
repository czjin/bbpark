...
class T_VIEW_EXPORT parkattendants_indexView : public TActionView
{
  Q_OBJECT
public:
  parkattendants_indexView() : TActionView() { }
  parkattendants_indexView(const parkattendants_indexView &) : TActionView() { }
  QString toString();
};

QString parkattendants_indexView::toString()
{
  responsebody.reserve(2060);
  responsebody += QLatin1String("<!DOCTYPE html>\n");
    responsebody += QLatin1String("<html>\n<head>\n  <meta http-equiv=\"content-type\" content=\"text/html;charset=UTF-8\" />\n  <title>");
  responsebody += THttpUtility::htmlEscape(controller()->name() + ": " + controller()->activeAction());
  responsebody += QLatin1String("</title>\n</head>\n<body>\n\n<h1>Listing Park Attendants</h1>\n\n");
  responsebody += QVariant(linkTo("New entry", urla("entry"))).toString();
  responsebody += QLatin1String("<br />\n<br />\n<table border=\"1\" cellpadding=\"5\" style=\"border: 1px #d0d0d0 solid; border-collapse: collapse;\">\n  <tr>\n    <th>ID</th>\n    <th>Name</th>\n    <th>Code</th>\n    <th>Real Name</th>\n    <th>Sex</th>\n    <th>Avatar</th>\n  </tr>\n");
  tfetch(QList<ParkAttendants>, parkAttendantsList);
  for (const auto &i : parkAttendantsList) {;
...
Q_DECLARE_METATYPE(parkattendants_indexView)
T_REGISTER_VIEW(parkattendants_indexView)

#include "parkattendants_indexView.moc"
